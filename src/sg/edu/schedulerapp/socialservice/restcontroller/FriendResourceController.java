...
import sg.edu.schedulerapp.socialservice.exception.StoreDataException;
import sg.edu.schedulerapp.socialservice.service.MaintainFriendService;
...
public class FriendResourceController {
	...
	// URI:  http://localhost:8080/SchedulerAppSocialService/rest/socialservice/friends/myfriends
	@GET
	...
	// URI: http://localhost:8080/SchedulerAppSocialService/rest/socialservice/friends/myfriends/receivedRequests
	...
	// URI: http://localhost:8080/SchedulerAppSocialService/rest/socialservice/friends/myfriends/sentRequests
	@Path("sentRequests")
	@GET
	@Produces( { MediaType.APPLICATION_JSON })
	...
	// URI: http://localhost:8080/SchedulerAppSocialService/rest/socialservice/friends/myfriends/sendFriendRequest?requestEmail=*
	...
	// URI: http://localhost:8080/SchedulerAppSocialService/rest/socialservice/friends/myfriends/acknowledge?requestEmail=*&acknowledge=accept(deny)
	@Path("acknowledge")
	@GET
	@Produces( { MediaType.APPLICATION_JSON })
	...
	// URI: http://localhost:8080/SchedulerAppSocialService/rest/socialservice/friends/myfriends/delete?requestEmail=*
	@Path("delete")
	@GET
	@Produces( { MediaType.APPLICATION_JSON })
