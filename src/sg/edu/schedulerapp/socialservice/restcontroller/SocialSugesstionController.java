...
import sg.edu.schedulerapp.socialservice.exception.DataTransitionException;
import sg.edu.schedulerapp.socialservice.service.SocialSuggestionService;
...
public class SocialSugesstionController {
    ...
    // URI:  http://localhost:8080/SchedulerAppSocialService/rest/socialservice/socialsuggestion?userScheduleData=*
    @GET
