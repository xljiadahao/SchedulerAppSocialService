...
values('xulei','xulei','male','xu','lei','10@nus.edu.sg');
insert into USER(NAME,PASSWORD,GENDER,FAMILY_NAME,GIVEN_NAME,EMAIL) 
values('xingzibo','xingzibo','male','xing','zibo','28@nus.edu.sg');
insert into USER(NAME,PASSWORD,GENDER,FAMILY_NAME,GIVEN_NAME,EMAIL) 
values('aakanksha','aakanksha','female','bansal','aakanksha','49@nus.edu.sg');
insert into USER(NAME,PASSWORD,GENDER,GIVEN_NAME,EMAIL) 
values('chandrakala','chandrakala','female','chandrakala','19@nus.edu.sg');
insert into USER(NAME,PASSWORD,GENDER,FAMILY_NAME,GIVEN_NAME,EMAIL) 
values('karthik','karthik','male','aiyer','karthik','949@nus.edu.sg');
insert into USER(NAME,PASSWORD,GENDER,GIVEN_NAME,EMAIL) 
values('ramprasath','ramprasath','male','ramprasath','939@nus.edu.sg');
insert into USER(NAME,PASSWORD,GENDER,FAMILY_NAME,GIVEN_NAME,EMAIL) 
values('sruthi','sruthi','female','morusu','sruthi','01@nus.edu.sg');
...
insert into FRIEND_REQUEST_BUFFER(SEND_REQUEST_USER_EMAIL, RECEIVE_REQUEST_USER_EMAIL) values('01@nus.edu.sg','10@nus.edu.sg');
